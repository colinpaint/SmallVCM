...
class HtmlWriter {
public:
  enum BorderColor { kNone, kRed, kGreen };

  //{{{
  HtmlWriter(const std::string& aFileName) : mFileName(aFileName), mHtml(mFileName.c_str()) {
  ...
  //}}}
  //{{{
  void AddRendering (const std::string &aMethodName,
  ...
  //}}}
  //{{{
  void AddFourWaySplit (const std::string aMethodFiles[4],
